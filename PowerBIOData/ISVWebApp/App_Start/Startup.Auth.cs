...
namespace ISVWebApp
{
    public partial class Startup
    {
        ...
        //public static string acmeAppResourceId = ConfigurationManager.AppSettings["ida:acmeAppResourceId"];
        //public static string acmeClientId = ConfigurationManager.AppSettings["ida:acmeClientId"];
        //public static string acmeAppKey = ConfigurationManager.AppSettings["ida:acmeAppKey"];
        //public static string acmeAuthority = String.Format("{0}/{1}", aadInstance, "pliuacme.onmicrosoft.com");
